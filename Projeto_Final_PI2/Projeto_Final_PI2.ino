...
#define CHAVE2        BIT2 // Porta 1
#define CHAVE3        BIT4 // Porta 1
#define CHAVE4        BIT7 // Porta 1
#define SENSOR        BIT1 // Porta 1
...
int main(void) {
 ...
 TACTL = TASSEL_2 + ID_3 + MC_1; //TASSEL_2 -> CLOCK SOURCE: MCLK  MC_1 ->                           //TIMER COM CONTAGEM PROGRESSIVA DE 0 ATÉ TACCR1
 ...
 P1OUT |= LED;
 P1DIR |= CLK1|LED;
 P1DIR &= ~(CHAVE1|CHAVE2|CHAVE3|CHAVE4|CLK2|SENSOR);
...
{
  while((P1IN&CHAVE1 && P1IN&CHAVE2 && P1IN&CHAVE3 && P1IN&CHAVE4 && P1IN&SENSOR ) ==0){
    P1OUT &= ~LED;
